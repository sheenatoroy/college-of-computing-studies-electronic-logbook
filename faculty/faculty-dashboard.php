...
<?php
    ...
    $sql = "SELECT
        ...
        WHERE a.remarks = 'Pending' OR a.remarks = 'Decline' AND (p.username = '$username')
        ...
        <div class="row-md-4 sm-4">
            <form class="d-flex">
                ...
                <button type="button" class="btn fs-5 text-white" data-bs-toggle="modal" data-bs-target="#notificationModal">
                    ...
                    if ($notificationCount > 0 && strpos($username, 'faculty') === false) {
                            ...
                            <div class="col-md-4">
                                <div class="alert alert-secondary text-dark shadow-sm rounded p-4 mt-3">
                                    ...
                                    <div class="card text-center mb-3 shadow-sm bg-body rounded">
                                        ...
                                        <div class="card-body">
                                            <h3 class="card-title">
                                                <a style="text-decoration: none; color:black;" href="../faculty/faculty-pending-appointment.php"><?php echo $countPending; ?></a>
                                            </h3>
                                        </div> 
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="alert alert-secondary text-dark shadow-sm rounded p-4 mt-3">
                                    ...
                                    <div class="card text-center mb-3 shadow-sm bg-body rounded">
                                        ...
                                        <div class="card-body">
                                            <h3 class="card-title">
                                                <a style="text-decoration: none; color:black;" href="../faculty/faculty-approved-appointment.php"><?php echo $countApproved; ?></a>
                                            </h3>
                                        </div> 
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="alert alert-secondary text-dark shadow-sm rounded p-4 mt-3">
                                    ...
                                    <div class="card text-center mb-3 shadow-sm bg-body rounded">
                                        ...
                                        <div class="card-body">
                                            <h3 class="card-title">
                                                <a style="text-decoration: none; color:black;" href="../faculty/faculty-accomplished-appointment.php"><?php echo $countDone; ?></a>
                                            </h3>
                                        </div>
                                    </div>
                                </div>
