...
if (isset($_POST['submitFeedback'])) {
    ...
    $update_query = "UPDATE appointments SET evaluation_status = 'Done', remarks = 'Done' WHERE appointment_id = '$appointment_id'";
    $update_query_run = mysqli_query($conn, $update_query);

    if ($query_run && $update_query_run) {
        echo '<script> alert("Evaluation Done!"); window.location.href = "../faculty-feedback.php"; </script>';
    } else {
