    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        if ($updateResult) {
            ...
            if ($studentDetailsResult && mysqli_num_rows($studentDetailsResult) > 0 && $profDetailsResult && mysqli_num_rows($profDetailsResult) > 0) {
                ...
                // Send the email
                if ($mail->send()) {
                    echo '<script> alert("Approving Appointment Successfully!"); window.location.href = "../faculty-approved-appointment.php"; </script>';
                } else {
                    echo '<script> alert("Remarks Updated Successfully. Email Not Sent. Error: ' . $mail->ErrorInfo . '"); window.location.href = "../faculty-pending-appointment.php"; </script>';
                }
            } else {
                echo '<script> alert("Error fetching student details for email"); window.location.href = "../faculty-pending-appointment.php"; </script>';
            }
        } else {
            echo '<script> alert("Failed to Update Remarks"); window.location.href = "../faculty-set-appointment.php"; </script>';
        }
    } else {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        if ($updateResult) {
            ...
            if ($studentDetailsResult && mysqli_num_rows($studentDetailsResult) > 0 && $profDetailsResult && mysqli_num_rows($profDetailsResult) > 0) {
                ...
                // Send the email
                if ($mail->send()) {
                    echo '<script> alert("Declining the Appointment Successfully!."); window.location.href = "../faculty-pending-appointment.php"; </script>';
                } else {
                    echo '<script> alert("Remarks Updated Successfully. Email Not Sent. Error: ' . $mail->ErrorInfo . '"); window.location.href = "../faculty-pending-appointment.php"; </script>';
                }
            } else {
