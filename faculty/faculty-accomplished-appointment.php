...
<meta charset="UTF-8">
    ...
    <title>CCS: E-LOG | Accomplished Appointment</title>
</head>
<style>
    body{
...
<div class="modal fade" id="actionReportModal">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        ...
        <div class="modal-header">
            ...
            <form action="./functions/uploadActionReport.php" method="POST" enctype="multipart/form-data">
                <div class="modal-body" style="max-height: 60vh; overflow-y: auto;">
                    <div class="row">
                        <div class="col-md-6">
                ...
                .then(data => {
                    ...
                    // Enable/disable the button based on remarks
                        ...
                        if (remarks === 'Pending') {
                            ...
                            actionReportButton.style.display = 'none';
