            ...
            <div class="col-xl">
                <div class="row justify-content-center">
                            ...
                            <div class="col-md-4">
                                <div class="alert alert-secondary text-dark shadow-sm rounded p-4 mt-3">
                                    ...
                                    <div class="card text-center mb-3 shadow-sm bg-body rounded">
                                        ...
                                        <div class="card-body">
                                            <h3 class="card-title">
                                                <a style="text-decoration: none; color:black;" href="../student/student-pending-appointment.php"><?php echo $countPending; ?></a>
                                            </h3>
                                        </div> 
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="alert alert-secondary text-dark shadow-sm rounded p-4 mt-3">
                                    ...
                                    <div class="card text-center mb-3 shadow-sm bg-body rounded">
                                        ...
                                        <div class="card-body">
                                            <h3 class="card-title">
                                                <a style="text-decoration: none; color:black;" href="../student/student-approved-appointment.php"><?php echo $countApproved; ?></a>
                                            </h3>
                                        </div> 
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="alert alert-secondary text-dark shadow-sm rounded p-4 mt-3">
                                    ...
                                    <div class="card text-center mb-3 shadow-sm bg-body rounded">
                                        ...
                                        <div class="card-body">
                                            <h3 class="card-title">
                                                <a style="text-decoration: none; color:black;" href="../student/student-accomplished-appointment.php"><?php echo $countDone; ?></a>
                                            </h3>
                                        </div>
                                    </div>
                                </div>
                    ...
                    ?>
                        ...
                        <?php
                        $sql_get = "SELECT * FROM prof WHERE account_type IN ('Admin', 'Faculty')";
                        $query = mysqli_query($conn, $sql_get);
                        ?>

                        <!--CCS Faculty Members-->
                        <div class="alert alert-secondary text-dark shadow-sm rounded p-4 mt-3">
                            <h4 class="pt-2 mb-3"><i class='bx bx-face mx-2'></i>CCS Faculty Members</h4>
                            <div class="mb-3">
                                        ...
                                        <div class="carousel-item active">
                                            ...
                                            <div class="card-group">
                                                ...
                                                while ($row = mysqli_fetch_assoc($query)) {
                                                    ...
                                                    // Fetch sections for the current professor
                                                    $sql_get_sections = "SELECT DISTINCT s.year_section
                                                                        FROM subj_management s
                                                                        INNER JOIN prof p ON s.status = p.username
                                                                        WHERE p.username = '$prof_username'";

                                                    $query_sections = mysqli_query($conn, $sql_get_sections);
                                                    $sections_handled = [];

                                                    while ($section_row = mysqli_fetch_assoc($query_sections)) {
                                                        $sections_handled[] = $section_row["year_section"];
                                                    }
                                                ?>
                                                <div class="card m-2">
                                                    <img src="<?php echo $row["itempic"] ?>" class="card-img-top w-50 mx-auto" alt="...">
                                                    <div class="card-body">
                                                        <input type="hidden" name="username" value="<?php echo $row["username"]?>">
                                                        <h5 class="card-title"><?php echo $row["lastname"] . ", " . $row["firstname"] ?></h5>
                                                        <p class="card-text"></p>
                                                    </div>
                                                    <ul class="list-group list-group-flush">
                                                        <li class="list-group-item">Sections handled: <?php echo implode(", ", $sections_handled); ?></li>
                                                    </ul>
                                                    <button type="button" class="btn float-end text-light view-btn" style="background-color: #F56904;" data-bs-toggle="modal" data-bs-target="#facultyModalView" data-username="<?php echo $prof_username; ?>">View</button>
                                                </div>
                                                <?php
                                                    $count++;
                                                }
                        ...
                        <!-- Faculty Modal View -->
                        <div class="modal fade" id="facultyModalView" aria-hidden="true" aria-labelledby="exampleModalToggleLabel2" tabindex="-1">
                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalToggleLabel2">Date of Availability</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        <div class="card mb-2 m-2">
                                            ...
                                            <div class="card-body" id="availability-schedule">
                                                <!-- Availability schedule will be loaded here via AJAX -->
                                            </div>
                                        </div>
                                    </div>
                                    <div class="modal-footer">
                        ...
                        <script>
                            $(document).ready(function () {
                                $('#facultyModalView').on('show.bs.modal', function (e) {
                                    var profId = $(e.relatedTarget).data('username');
                                    
                                    // Make AJAX request to fetch professor's availability start times
                                    $.ajax({
                                        type: 'GET',
                                        url: '../functions/fetch_time_start_availability.php',
                                        data: { prof_id_resched1: profId },
                                        success: function (response) {
                                            var timeStart = JSON.parse(response).timeStart;
                                            $('#availability-schedule').empty(); // Clear existing content
                                            timeStart.forEach(function(time) {
                                                $('#availability-schedule').append('<p>Time Start: ' + time + '</p>');
                                            });
                                        },
                                    ...
                                    // Make AJAX request to fetch professor's availability end times
                                    $.ajax({
                                        type: 'GET',
                                        url: '../functions/fetch_time_end_availability.php',
                                        data: { prof_id_resched1: profId },
                                        success: function (response) {
                                            var timeEnd = JSON.parse(response).timeEnd;
                                            timeEnd.forEach(function(time) {
                                                $('#availability-schedule').append('<p>Time End: ' + time + '</p>');
                                            });
                                        },
                                        error: function (xhr, status, error) {
                                            console.error(xhr.responseText);
                                ...
                                while ($row = mysqli_fetch_assoc($result)) {
                                    if (strtotime($row['day']) >= strtotime(date('Y-m-d', strtotime('today')))) {
                                        ...
                                        if (isset($row['time_start']) && isset($row['time_end'])) {
                                            $startTime = date('h:ia', strtotime($row['time_start']));
                                            $endTime = date('h:ia', strtotime($row['time_end']));
