                                ...
                                if (mysqli_num_rows($result_appointments) > 0) {
                                    while ($row = mysqli_fetch_assoc($result_appointments)) {
                                        ...
                                        echo "<div class='btn-group btn-group-sm' role='group'>
                                                    <button type='button' class='btn btn-success m-1 reschedBtn' title='Reschedule' data-bs-toggle='modal' 
                                                        data-appointment-id='$appointment_id' 
                                                        data-prof-id='$prof_id' 
                                                        data-fullname-prof='$prof_fullname'
                                                        data-student-id = '$student_id'
                                                        data-student-name = '$student_fullname'
                                                        data-year-section = '$year_section'
                                                        data-email = '$email'>
                                ...
                                <div class="timeline">
                                    <div class="timeline-outer">
                                        <div class="timeline-card">
                                            ...
                                            <div class="timeline-info">
                                                <h5 class="timeline-title mt-2">Step 3: <span style="font-style:italic; font-size: 15px">Action Report will upload by the Professor.</span></h5>
                                            </div>
                                            
                                            <div class="timeline-info">
                                                <h5 class="timeline-title mt-2">Step 4: <span style="font-style:italic; font-size: 15px">Evaluate your appointment.</span></h5>
                                            </div>
