    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-xl">
                <div class="row justify-content-center">
                    ...
                    <?php
                        $sql = "SELECT
                                    ...
                                    JOIN student s ON a.student_id = s.username
                                    JOIN prof p ON a.prof_id = p.username
                                    WHERE a.remarks = 'Done'
                                        AND (s.username = '$username')
                                    ORDER BY a.day ASC;";
                        $result = mysqli_query($conn, $sql);
                    ?>
                    <div class="alert alert-secondary text-dark shadow-sm rounded p-4 mt-3">
                    <h4 class="pt-2 mb-3"><i class='bx bx-list-ul mx-2'></i>Accomplished Appointments</h4>
                    <div class="row">
                        <div class="col">
                        ...
                        if (isset($_POST['search'])) {
                            ...
                            $sql_appointments = "SELECT 
                                                ...
                                                JOIN student s ON a.student_id = s.username
                                                JOIN prof p ON a.prof_id = p.username
                                                WHERE a.student_id = ? AND a.remarks = 'Done'
                            ...
                            $sql_appointments = "SELECT 
                                                ...
                                                JOIN student s ON a.student_id = s.username
                                                JOIN prof p ON a.prof_id = p.username
                                                WHERE a.student_id = '$username' AND a.remarks= 'Done'";
                ...
                $remarks = "";
                $disabled = true; 
                $evaluationMessage = ""; // Initial state (adjust based on your logic)
                                ...
                                <div class="timeline">
                                    <div class="timeline-outer">
                                        <div class="timeline-card">
                                            ...
                                            <div class="timeline-info">
                                                <h5 class="timeline-title mt-2">Step 4:<span style="font-style:italic; font-size: 15px"> Evalute your appointment</span></h5>
                                            </div>
                                    ...
                                    <div class="modal-body" style="max-height: 60vh; overflow-y: auto;">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-floating mt-2" style="display: none;">
                                                    <input type="text" class="form-control" name="evaluation_status_view" id="evaluation_status_view" placeholder="" disabled>
                                                    <input type="hidden" class="form-control" name="evaluation_status_view" id="hidden_evaluation_status_view" placeholder="">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <script>
                        ...
                        document.querySelectorAll('.detailsBtn').forEach(button => {
                            button.addEventListener('click', function () {
                                ...
                                document.getElementById('evaluation_status_view').value = evalStatus;
                            ...
                            fetch('fetch_status_message.php?appointment_id=' + appointmentId)
                                ...
                                fetch('fetch_status_message.php?remarks=' + remarks + evalStatus)
                                    ...
                                    .then(data => {
                                        ...
                                        console.log('Eval Status: ', evalStatus); // Debugging line
