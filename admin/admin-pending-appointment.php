...
<meta charset="UTF-8">
    ...
    <title>CCS: E-LOG | Pending Appointment</title>
</head>
<style>
    body{
                ...
                <div class="row justify-content-center">
                    ...
                    <?php
                        ...
                        <div class="alert alert-secondary text-dark shadow-sm rounded p-4 mt-3 table-responsive">
                            <h4 class="pt-2 mb-3"><i class="bx bx-list-ul mx-2"></i>Pending Appointments</h4>
                                                ...
                                                if (mysqli_num_rows($result)) {
                                                    while ($row = mysqli_fetch_assoc($result)) {
                                                        ...
                                                        echo '<tr style="text-align: center;">';
                                                            ...
                                                            echo '<td>' . $remainingDays . ' days left' . '</td>';

                                                            echo '<td>' . $row['remarks'] . '</td>';

                                                            echo '<td>';
                                                            echo '<div class="btn-group btn-group-sm" role="group">';
                                                            echo '<button type="button" class="btn btn-success m-1 appBtn" title="Reschedule">
                                                            ...
                                                            echo '<button type="button" class="btn btn-warning m-1 viewBtn" title="View"
                                                                        ...
                                                                        data-specific-concern="'.$row['specific_concern'].'"
                                                                        data-type-of-concern="'.$row['type_of_concern'].'"
                                                                        data-detailed-concern="'.$row['detailed_concern'].'"
                                                                        data-day="'.$row['day'].'"
                                                                        data-time-start="'.$row['time_start'].'"
                                                                        data-time-end="'.$row['time_end'].'"
                                                                        data-appointment-status="'.$row['appointment_status'].'">
                                                                        <i class="fa fa-eye" style="color: white;"></i>
                                                                </button>';
                                                            
                                                            echo '<button type="button" class="btn btn-primary m-1" disabled><i class="bx bxs-file"></i></button>';
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="hidden" id="specific_concern_input" name="specific_concern_input" value="">
                <input type="hidden" id="detailed_concern_input" name="detailed_concern_input" value="">
                <input type="hidden" id="type_of_concern_input" name="type_of_concern_input" value="">
                <input type="hidden" id="time_start_input" name="time_start_input" value="">
                <input type="hidden" id="time_end_input" name="time_end_input" value="">
                <input type="hidden" id="day_input" name="day_input" value="">
                <input type="hidden" id="appointment_status_input" name="appointment_status_input" value="">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-floating mt-2">
                                ...
                                <input type="hidden" class="form-control" name="hidden_day_view" id="hidden_day_view" value="" placeholder="">
                            ...
                            <div class="form-floating mt-2">
                                ...
                                <input type="hidden" class="form-control" name="hidden_time_start_view" id="hidden_time_start_view"  value="" placeholder="">
                            ...
                            <div class="form-floating mt-2">
                                ...
                                <input type="hidden" class="form-control" name="hidden_time_end_view" id="hidden_time_end_view"  value="" placeholder="">
                            ...
                            <div class="form-floating mt-2">
                                ...
                                <input type="hidden" class="form-control" name="hidden_type_of_concern_view" id="hidden_type_of_concern_view" value="" placeholder="">
                            ...
                            <div class="form-floating mt-2">
                                ...
                                <input type="hidden" name="hidden_specific_concern_view" id="hidden_specific_concern_view" value="" placeholder="">
                            ...
                            <div class="form-floating mt-2">
                                ...
                                <input type="hidden" class="form-control" name="hidden_appointment_status_view" id="hidden_appointment_status_view" value="" placeholder="">
                            ...
                            <div class="form-floating mt-2">
                                ...
                                <input type="hidden" class="form-control" name="hidden_detailed_concern_view" id="hidden_detailed_concern_view" value="" placeholder="">
                            ...
                            <div class="form-floating mt-2">
                                ...
                                <input type="hidden" class="form-control" name="hidden_resched_reason" id="hidden_resched_reason" value="" placeholder="">
...
<script>
    $(document).ready(function () {
        $('.appBtn').on('click', function (e) {
            ...
            // Listen for changes on the time start select element
            $('#time_start').on('change', function () {
                var selectedTimeStart = $(this).val(); // Get the selected time start
                var day = $('#edit_day').val();
                var studentId = $('#student_id').val(); // Get the student ID

                console.log('Selected Time Start:', selectedTimeStart);
                console.log('Selected Day:', day);
                console.log('Student ID: ', studentId);

                // $.ajax({
                //     url: './functions/time_fetch.php',
                //     method: 'GET',
                //     data: { student_id: studentId, edit_day: day, edit_time: selectedTime },
                //     dataType: 'json',
                //     success: function (response) {
                //         if (response.success) {
                //             if (response.pending) {
                ...
                //             } else {
                //                 // Do something if there is no pending appointment
                //             }
                //         } else {
                //             console.error('Error checking pending appointment:', response.error);
                //         }
                //     },
                //     error: function (xhr, status, error) {
...
<script>
    ...
    document.querySelectorAll('.detailsBtn').forEach(button => {
        button.addEventListener('click', function () {
            ...
            var specificConcern = document.getElementById('specific_concern_input').value;
            var userloggedIn = "<?php echo htmlspecialchars($username, ENT_QUOTES, 'UTF-8'); ?>";
            var detailedConcern = document.getElementById('detailed_concern_input').value;
            var typeOfConcern = document.getElementById('type_of_concern_input').value;
            var dayAppointment = document.getElementById('day_input').value;
            var timeStart = document.getElementById('time_start_input').value;
            var timeEnd = document.getElementById('time_end_input').value;
            var appointmentStatus = document.getElementById('appointment_status_input').value;
            ...
            console.log("Specific Concern: ", specificConcern);
            console.log("Detailed Concern: ", detailedConcern);
            console.log("Type of Concern: ", typeOfConcern);
            console.log("Day: ", dayAppointment);
            ...
            document.getElementById('hidden_specific_concern_view').value = specificConcern;
            document.getElementById('hidden_detailed_concern_view').value = detailedConcern;
            document.getElementById('hidden_type_of_concern_view').value = typeOfConcern;
            document.getElementById('hidden_day_view').value = dayAppointment;
            document.getElementById('hidden_time_start_view').value = timeStart;
            document.getElementById('hidden_time_end_view').value = timeEnd;
            document.getElementById('hidden_appointment_status_view').value = appointmentStatus;
...
<script>
    ...
    viewButtons.forEach(button => {
        button.addEventListener('click', function () {
            ...
            const specificConcern = this.getAttribute('data-specific-concern');
            const detailedConcern = this.getAttribute('data-detailed-concern');
            const typeOfConcern = this.getAttribute('data-type-of-concern');
            ...
            document.getElementById('specific_concern_input').value = specificConcern;
            document.getElementById('type_of_concern_input').value = typeOfConcern;
            document.getElementById('detailed_concern_input').value = detailedConcern;
            document.getElementById('time_start_input').value = timeStart;
            document.getElementById('time_end_input').value = timeEnd;
            document.getElementById('day_input').value = day;
            document.getElementById('appointment_status_input').value = appointmentStatus;
