    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-xl">
                ...
                <div class="container-fluid mt-4" id="tableStudent">
                    <!-- Search bar -->
                    <div class="row justify-content-center">
                                <div class="col-md-6">
                                <form class="form-inline" method="GET" action="">
                                        <div class="input-group">
                                        <input type="text" name="search" class="form-control mr-sm-2" id="searchInputFaculty" placeholder="Search by Student ID or Name" value="<?php echo isset($_GET['search']) ? htmlspecialchars($_GET['search']) : ''; ?>">
