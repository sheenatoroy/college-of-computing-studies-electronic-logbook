...
<meta charset="UTF-8">
    ...
    <title>CCS: E-LOG | Summary Appointment</title>
</head>
<style>
    body{
                ...
                <div class="row justify-content-center">
                    ...
                    <?php
                        ...
                        $sql = "SELECT
                                    ...
                                    JOIN student s ON a.student_id = s.username
                                    JOIN prof p ON a.prof_id = p.username
                                    WHERE remarks = 'Done' OR remarks = 'Unresolved'
                                    ORDER BY a.day ASC;";
                                    $result = mysqli_query($conn, $sql);
                        ?>
                        ...
                        <div class="alert alert-secondary text-dark shadow-sm rounded p-4 mt-3 table-responsive">
                            <h4 class="pt-2 mb-3"><i class="bx bx-list-ul mx-2"></i>Summary Appointments</h4>
