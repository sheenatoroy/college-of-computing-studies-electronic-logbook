...
if (isset($_POST['updateActionReport'])) {
    ...
    if (mysqli_num_rows($result) > 0) {
        if (move_uploaded_file($_FILES["action_report"]["tmp_name"], $target_file)) {
            ...
            action_report = '$target_dir', action_report_path = '$target_dir2', action_report_textbox = '$action_report_textbox' WHERE appointment_id = '$appointment_id'";
            ...
            if ($query_run) {
                    ...
                    echo '<script> alert("Action report successfully uploaded!"); window.location.href = "../admin-unresolved-appointment.php"; </script>';
